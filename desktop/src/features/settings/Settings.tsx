// SETTINGS: the things that otherwise only exist as CLI flags and JSON files. Mostly read-only on
// purpose (hub pins and identity are written by `trantor hub set` and enrolment; a second writer
// invites disagreement); app behavior (notifications) is writable. The Update button fronts a
// real in-process updater: download the DMG, swap /Applications, relaunch.
