// Chat panel preferences: reading-comfort dials (#5522) and the terminal tray's folded state
// (#5523), pure and persisted to localStorage as "trantor.chat.open"/"trantor.chat.dock",
// siblings of AppShell's own panel keys. The store is injected like TerminalDeps injects the
// pane's reach; every reader is total, falling back to the default rather than crash or lie.
