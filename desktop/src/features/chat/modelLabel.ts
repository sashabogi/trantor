// The model dial's label at 440px (#5841): the brand mark says WHOSE model, the version says which
// ("5.1" beside the Claude mark). The family and the full id ride the tooltip.
