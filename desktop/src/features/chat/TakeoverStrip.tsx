...
// Shared by the locked composer and the Workspace empty state (#5479) so both offer the SAME
// action from the same inventory; a takeover that failed silently is a trap.
