...
// #6005: an assistant reply that is markdown renders AS markdown (real <ul>/<li>, <strong>, <code>)
// and never shows the literal "**" / "- " syntax. The fixture is shaped like a real orchestrator reply.
