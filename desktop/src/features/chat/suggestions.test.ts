...
// The crebral-health merge-confirm turns, verbatim from a real transcript where the operator saw
// NO chips (#5993). Two orchestrator turns since the operator's last word, newest first.
