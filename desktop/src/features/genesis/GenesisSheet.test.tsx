...
// pasting outside a text input selects From a brief and fills it, and the create call carries a
// brief only on that path. Tauri arrives via the sheet's own deps seam (#6253), never a module mock.
