// The search palette (#5625): ONE component, two scopes. Project scope is the trigger above every
// lens; global scope is ⌘K anywhere (projects by name plus cards across every board). Results
// speak the board's vocabulary (match.ts): text, #id, @assignee, then message/event/file rows.
