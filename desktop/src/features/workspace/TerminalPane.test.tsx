...
// The pane is exercised through injected dependencies, never module mocking: it runs its real
// effects against a faithful stand-in (terminalDouble.ts) implementing the same surface the
