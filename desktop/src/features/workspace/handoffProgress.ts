// The Workspace's read on a running handoff chain (#6081). Rust marks the project for
// the whole chain (handoff write, idle gate, kill, reopen, kickoff), so the pane tab can
// say the session is doomed before anyone types into it. One invoke plus one event name,
