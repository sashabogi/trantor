...
// The mode rail's width→layout contract (#6036): a tab word NEVER truncates. The strip MEASURES both
// sides, and the measuring twins live under the SAME cascade as the real tabs (unlayered
// `.tr-seg > button` CSS beats utilities). Pinned around equality, hysteresis, and a 270px strip.
