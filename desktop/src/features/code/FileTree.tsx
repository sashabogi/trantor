// The project's file tree, in the sidebar, with git state on every row: its job is
// witness, not navigation, showing which files the crew is touching without asking anyone.
// Supports create/rename/delete, all path-guarded so no operation can escape the project root.
    ...
    <>
      <div
        className={`relative flex w-full items-center gap-1.5 rounded-md py-[3px] pr-2 text-left text-[12px] hover:bg-white/[0.04] ${
          /* the OPEN file's row gets the same treatment the sidebar gives the active project. */
