// The sub-agent roll-up: ONE quiet line standing in for every cc-subagent card, collapsed by
// default since these are machine bookkeeping that would otherwise bury real work as flat siblings.
// `variant="nested"` (under a focus card) shows that session's sub-agents, joined on `parent ===
// cc`; `variant="lane"` (lane head) is the fallback for cards Board.tsx's join could not resolve.
