// CardDetail: the drawer a card opens into, shared by BOARD and FEED. The card's own `log` leads as
// the STORY (CARDLOG contract); the /card thread (events + messages referencing #<id>, derived, never
// stored) follows as the supplement. A tile says WHAT state; the drawer says WHY.
