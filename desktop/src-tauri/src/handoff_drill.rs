...
//! and `handoff_now` refuses (Err, traced) before writing anything. `TRANTOR_HANDOFF_DRILL=<project>`
//! emits `handoff-drill` after boot; the verdict reads only this run's app-trace.log. Exit 0 / 3.
