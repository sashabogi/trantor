// trantor — hub split-brain detection (TDD §12.1): probe every hub this machine knows, ask who is live,
// compare with the pins. probeHub() reports a REASON, never a silent empty roster (a 401 is not "empty").
...
/** Cross-check live presence (probeHub() results, one per hub) against the pins in config.json.
