// trantor — a signing drop-in for fetch, one call-site shape for every client. FAIL-OPEN IS A CONTRACT:
// no identity or an unreadable key sends the request UNSIGNED; only the hub knows the policy.
