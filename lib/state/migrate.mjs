...
/** Migrate an object of any known version up to v3. An unmigratable object returns MIGRATE_FAILED;
 *  the STORE keeps the original under `.v<n>.json`, this function only reports.
