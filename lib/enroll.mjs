// trantor — a seat self-enrols on an enforce hub at startup (TDD §7.4): the operator's owner key mints
// a single-use, project-scoped invite the seat spends at once, so it never holds owner rights.
