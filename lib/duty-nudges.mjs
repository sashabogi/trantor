...
/**
 * Drop escalations the recipient has ALREADY read (#7131): a nudge wakes a session on both sides.
 * `isDelivered` is injected (a /peer lookup, SINGULAR); unknown is never treated as delivered.
 */
