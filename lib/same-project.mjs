// #5760 — the same-project OVERSEER warning is an EPISODE, not a timer: it fires once when the
// membership set changes, reports duration, and only sessions outside the declared crew count. Pure.
