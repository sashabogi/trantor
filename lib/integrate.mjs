// The orchestrator's integration pass: collect seat/<agent> work, check for collisions, prove it,
// then push — automated, the steps unchanged. Every stage can refuse and reports WHY.
...
/** Merge one seat's branch into the current checkout. A conflict is the collision the overseer exists
 *  to surface, so the merge is aborted and reported rather than left half-done. */
