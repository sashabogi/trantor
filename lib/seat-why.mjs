...
// Reads, in order: err-<agent>-<proj>.txt, logs/<agent>-<proj>.jsonl, crew-windows.txt, live
// crew-runner processes. Returns { state, why, advice }, state ∈ live | dead-quota | dead-auth |
