...
// someone wanted to skip permission prompts. TWO of the three live in this file:
//
...
//
// The third dial — what a CREW AGENT may do unattended — deliberately does NOT live here. That is
// the overseer's autonomy level, it is per project, and it lives on the HUB because it is shared
// team state rather than a property of this laptop. Two controls for one concept in two stores is
// how they end up disagreeing.
//
// The file is shared state on purpose: the app writes it, crew.mjs reads it when it starts your
