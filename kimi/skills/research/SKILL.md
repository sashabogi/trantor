...
description: |
  ...
  many sources. Trigger: /skill:research
whenToUse: When the user wants to research, deep-dive, "search the web", "see what people say about X", or look something up across many sources
---
...
- **No Agent-Reach?** Fall back to your own WebSearch/FetchURL tools — the method below still holds.
